  ...
  return (
    <main className="container-custom animate-in fade-in flex flex-grow items-center justify-center duration-1000 py-12">
        <div className="flex w-full max-w-[1000px] flex-col items-center gap-16 md:flex-row">
          ...
          <div className="group relative w-full flex-1 game-card p-2 shadow-none border-2 border-dashed border-[var(--card-border)] hover:border-primary">
            <Image 
          ...
          <div className="flex flex-1 flex-col items-start text-left">
            <h1 className="mb-6 text-[48px] font-game-heading leading-tight tracking-wider text-[var(--foreground)] uppercase">
              {t('title')}
            </h1>
            <div className="mb-8 p-6 game-card border-2 border-dashed border-primary/30">
