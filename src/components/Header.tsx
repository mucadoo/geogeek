...
export default function Header() {
  ...
  const isModalOpen = pathname.includes('/games/') && (status === 'idle' || status === 'finished');
  ...
  return (
    <header className={cn("z-50 w-full flex h-[90px] items-center relative mx-auto max-w-[1400px]", isModalOpen ? "bg-[var(--background)]/80 backdrop-blur-2xl" : "")}>
